  ...
  return (
    <div className="col-span-1 w-full lg:w-full bg-white p-4 sm:p-6 rounded-lg lg:h-80 xl:w-full shadow-md border-[1px]">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="absolute top-24 md:top-20 lg:top-16 lg:-ml-80">
        ...
        {/* Legend */}
        <div className=" md:mt-0 md:ml-8 grid grid-cols-1 md:grid-cols-2 gap-4 lg:w-72  ">
          <ul className="text-sm font-bold space-y-2">
            <li className="flex items-center">
              <span className="w-3 h-3 lg:h-16 rounded-full bg-blue-500 mr-2"></span>
              In Office: {data.attendance.details.InOffice}%
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 lg:h-16 rounded-full bg-yellow-500 mr-2"></span>
          ...
          <ul className="text-sm font-bold space-y-2">
            <li className="flex items-center">
              <span className="w-4 h-3 lg:h-16 rounded-full bg-red-500 mr-2"></span>
              Work from Home: {data.attendance.details.Workfromhome}%
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 lg:h-16 rounded-full bg-gray-500 mr-2"></span>
