...
const Timing = () => {
  return (
    <div className="col-span-1 w-full lg:w-auto bg-white p-4 sm:p-6 rounded-lg lg:h-80 shadow-md border-[1px]">
      {/* Header */}
      ...
      {/* Legend */}
      <div className="lg:-mt-4 lg:ml-24">
        <ul className="flex justify-center md:justify-start space-x-6 md:space-x-10">
